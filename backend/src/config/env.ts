...
const envSchema = z.object({
  ...
  RAZORPAY_APP_PLAN_ID: z.preprocess(emptyToUndefined, z.string().optional()),
  APP_SUBSCRIPTION_AMOUNT_PAISE: z.coerce.number().int().min(100).default(100),
  APP_SUBSCRIPTION_TOTAL_COUNT: z.coerce.number().int().min(1).max(120).default(120),
  APP_SUBSCRIPTION_GRACE_DAYS: z.coerce.number().int().min(0).max(30).default(0),
